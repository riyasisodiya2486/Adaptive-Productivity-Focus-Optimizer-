    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-center text-zinc-400 mb-8 text-base">
            Create your account and start managing your time with clarity.
          </p>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            <div>
              ...
              />
              {errors.name && (
                <p className="text-sm mt-2 text-rose-500">{errors.name.message}</p>
              )}
            </div>
            <div>
              ...
              />
              {errors.email && (
                <p className="text-sm mt-2 text-rose-500">{errors.email.message}</p>
              )}
            </div>
            <div>
              ...
              />
              {errors.password && (
                <p className="text-sm mt-2 text-rose-500">{errors.password.message}</p>
              )}
            </div>
            {error && (
              <motion.p
      ...
      <motion.div
        className="hidden md:flex flex-col justify-start w-1/2 relative overflow-hidden pt-10 px-10"
        initial={{ x: 100, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 1, ease: "easeOut" }}
      >
        ...
        />
        <div className="relative z-10 drop-shadow-[0_4px_16px_rgba(0,0,0,0.5)] text-right pr-">
          <h2 className="text-3xl font-bold text-white leading-snug">
            “Every new beginning<br />starts with a moment of focus.”
          </h2>
          <p className="mt-3 text-lg text-white/90 tracking-wide">
            Join FlowState — where productivity meets peace.
          </p>
        </div>
      </motion.div>
    </motion.div>
